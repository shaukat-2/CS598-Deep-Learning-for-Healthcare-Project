...
def load_data_simple(seqFile, labelFile, timeFile=''):
    sequences = np.array(pickle.load(open("C:\\Users\\SameenShaukat\\Downloads\\Project\\DL4H-Project\\local_mimic\\save\\3digitICD9.seqs", 'rb')))
    labels = np.array(pickle.load(open("C:\\Users\\SameenShaukat\\Downloads\\Project\\DL4H-Project\\local_mimic\\save\\morts", 'rb')))
    if len(timeFile) > 0:
...
if __name__ == '__main__':
    ...
    train_RETAIN(  # numClass=args.n_output_codes,
        ...
        outFile="C:\\Users\\SameenShaukat\\Downloads\\Project\\DL4H-Project\\local_mimic\\save\\checkpoint\\Mortality\\Retain\\retain",
